    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="my-4">
                    <form method="POST" action="/grados" autocomplete="off">
                        @csrf
                        ...
                        <div class="my-4">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input id="nombre_grado" name="nombre_grado" type="text" class="form-control" placeholder="Nombre" required >
                                </div>
                                <div class="col">
                                    <label for="seccion">Nombre del Seccion</label>
                                    <input id="seccion" name="seccion" type="text" class="form-control" placeholder="Seccion" required >
                                </div>
                            </div>
                        </div>
