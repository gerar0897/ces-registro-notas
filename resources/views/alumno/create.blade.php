    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="my-4">
                    <form method="POST" action="/alumnos" autocomplete="off">
                        @csrf
                        <label for="grado">Grado</label>
                        <select id="id_grado" name="id_grado" class="form-control" required>
                            <option selected>Seleccione...</option>
                            @foreach ($grados as $item)
                                <option value="{{ $item->ID_GRADO }}">{{ $item->NOMBRE_GRADO }} -
                                    {{ $item->SECCION }} </option>
                            @endforeach
                        </select>
                        ...
                        <div class="my-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="dui_tutor" name="dui_tutor"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepickers" id="fecha_nacimiento"
